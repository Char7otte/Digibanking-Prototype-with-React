        ...
        <div className="min-vh-100 d-flex align-items-center justify-content-center flex-column">
            ...
            <main className={`${styles.mainContainer} `}>
                <fieldset className={`${styles.radioFieldset} d-flex border-0`}>
                    ...
                    <div className={styles.radioContainer}>
                        <input type="radio" name="radio" id="otp" value="otp" checked={signOption === "otp"} onChange={() => setSignOption("otp")} />
                ...
                {signOption == "register" && (
                    <div>
                        ...
                        <form onSubmit={handleRegister} className={styles.loginForm}>
                            ...
                            <input type="text" name="name" id="name" placeholder="Enter your name" className="spacing-md" />
                            <label htmlFor="username" className="m-2">
                                PIN
                            </label>
                            <input type="text" name="password" id="password" placeholder="Enter your PIN number" className="spacing-md" />
                ...
                {signOption == "otp" && (
                    <div>
                        ...
                        <p className="subtitle pb-4">Enter the generated OTP to gain access to the account</p>
                        <form onSubmit={handleLogin} className={styles.loginForm}>
                            <input type="hidden" name="username" id="username" placeholder="Enter your username" className="spacing-md" value="bob" />
                            <input
                                type="hidden"
                                name="password"
                                id="password"
                            ...
                            <input type="text" name="otp" id="otp" placeholder="Enter your otp" className="spacing-md" />
                            <button type="submit" className="important-button mt-2">
                                Login
                            </button>
                            <hr />
